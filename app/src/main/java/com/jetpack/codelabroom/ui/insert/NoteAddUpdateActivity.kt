...
import com.jetpack.codelabroom.databinding.ActivityNoteAddUpdateBinding
import com.jetpack.codelabroom.helper.DateHelper
        ...
        binding?.btnSubmit?.setOnClickListener {
            ...
            if (title.isEmpty()) {
                ...
                if (isEdit) {
                    ...
                    note.let { note ->
                        note?.date = DateHelper.DateHelper.getCurrentDate()
                    }
